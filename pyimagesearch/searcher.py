...
class Searcher:        
	def __init__(self, indexPath, semanticsPath, textPath, deeplearningPath):
		...
		self.deeplearningPath = deeplearningPath
                '''self.WEIGHT_CH = 0.17
                self.WEIGHT_SEM = 0.36
                self.WEIGHT_SIFT = 0.1
                self.WEIGHT_TEXT = 0.2
                self.WEIGHT_DL = 0.17'''
                self.WEIGHT_CH = 0.07
                self.WEIGHT_SEM = 0.4
                self.WEIGHT_SIFT = 0.03
	...
	def search(self, queryFeatures, querySemantics, queryText, queryCategory, limit = 32):
